...
var _wordItem = require(".//dom/word-item");
var button = document.getElementById("add");
button.addEventListener("click", async function(event) {
    event.preventDefault();
    var searchWord = document.getElementById("searchWord").value;
    if (searchWord.length > 0) await (0, _dictionary.GetWordDefinition)(searchWord).then((data)=>{
        var definition = data[0].meanings[0].definitions[0].definition;
        (0, _wordItem.CreateWordItem)(searchWord, definition);
    }).catch((error)=>{
        console.log(error);
    });
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7",".//api/dictionary":"bzxk5",".//dom/word-item":"knX6L"}],"i5LP7":[function() {},{}],"bzxk5":[function(require,module,exports) {
// fetch from the dictionary api here!
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GetWordDefinition", ()=>GetWordDefinition);
async function GetWordDefinition(word) {
    return fetch(`https://api.dictionaryapi.dev/api/v2/entries/en/${word}`).then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gzp3I","1Z4Rq"], "1Z4Rq", "parcelRequire6cbc")
